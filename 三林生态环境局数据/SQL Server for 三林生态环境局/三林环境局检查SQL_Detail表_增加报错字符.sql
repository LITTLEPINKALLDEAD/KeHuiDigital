SELECT 
    ...
    CASE 
        ...
        WHEN [附件文号] LIKE '%[<]%' THEN '小于号'
        WHEN [附件文号] LIKE '%[>]%' THEN '大于号'
...
SELECT 
    ...
    CASE 
        ...
        WHEN [文件类型] LIKE '%[<]%' THEN '小于号'
        WHEN [文件类型] LIKE '%[>]%' THEN '大于号'
...
SELECT 
    ...
    CASE 
        ...
        WHEN [数字化处理员] LIKE '%[<]%' THEN '小于号'
        WHEN [数字化处理员] LIKE '%[>]%' THEN '大于号'
...
SELECT 
    ...
    CASE 
        ...
        WHEN [数字化处理员单位] LIKE '%[<]%' THEN '小于号'
        WHEN [数字化处理员单位] LIKE '%[>]%' THEN '大于号'
